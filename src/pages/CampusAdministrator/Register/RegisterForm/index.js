  ...
  async function handleRegisterForm(e) {
    ...
    try {
      ...
      if (response.status !== 201) {
        ...
        loadAlertSuccess();
        history.push('/campus/registerFormQuestion');
      }
    } catch (error) {
      console.log(error);
    }
        ...
        <div className={toggle ? 'main-disabled' : 'main-active'}>
          {
            showModal ? (
              ...
              />
                ...
                <>
                  <Description
                    description="Registrar Formulário"
                    tip="Área destinada para o registro de formulário de feedback."
                    color="#0B0A0D"
                  />
