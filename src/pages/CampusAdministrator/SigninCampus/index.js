...
export default function SigninCampus() {
  ...
  async function handleSignIn(e) {
    ...
    if (!email || !password) {
      ...
      try {
        ...
        if (response.data.fk_group_user_id === 2) {
          setLoading(false);
  ...
  return (
    <div className="container">
      <div className="box-signin">
        <div className="signin-left" style={{ backgroundColor: '#2cc464' }}>
          <div className="logo">
